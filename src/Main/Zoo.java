...
public class Zoo extends javax.swing.JFrame {
	...
	public void zooFrame() {
		...
		swanButton.setFont(new java.awt.Font("Courier", 1, 18)); // NOI18N
		...
		donkeyButton.setFont(new java.awt.Font("Courier", 1, 18)); // NOI18N
		...
		backgroundMusicButton.setFont(new java.awt.Font("Courier", 1, 18)); // NOI18N
		...
		duckButton.setFont(new java.awt.Font("Courier", 1, 18)); // NOI18N
		...
		zebraButton.setFont(new java.awt.Font("Courier", 1, 18)); // NOI18N
		...
		allButton.setFont(new java.awt.Font("Courier", 1, 18)); // NOI18N
		...
		lionButton.setFont(new java.awt.Font("Courier", 1, 18)); // NOI18N
		...
		tigerButton.setFont(new java.awt.Font("Courier", 1, 18)); // NOI18N
		...
		horseButton.setFont(new java.awt.Font("Courier", 1, 18)); // NOI18N
	...
	private void tigerImage(java.awt.event.ActionEvent animalEvent) {
		...
		Animal tigerfactory = catfactory.createAnimal("tiger");

		if (tigerClicked == 0) {
			tiger.setIcon(tigerfactory.appear());
			tiger.setVisible(true);
			tigerClicked = 1;
		} else if (tigerClicked == 1) {
			tiger.setIcon(tigerfactory.disappear());
			tiger.setVisible(true);
			tigerClicked = 0;
		}
		tiger.revalidate();
	...
	private void jaguarImage(java.awt.event.ActionEvent animalEvent) {// GEN-FIRST:event_kidbtnActionPerformed
		horse.setVisible(false);
		...
		AnimalFactory catfactory = new CatFactory();
		Animal lionfactory = catfactory.createAnimal("lion");

		if (lionClicked == 0) {
			lion.setIcon(lionfactory.appear());
			lion.setVisible(true);
			lionClicked = 1;
		} else if (lionClicked == 1) {
			lion.setIcon(lionfactory.disappear());
			lion.setVisible(true);
			lionClicked = 0;
		}
		lion.revalidate();
	...
	private void duckImage(java.awt.event.ActionEvent animalEvent) {
		...
		Animal duckfactory = birdfactory.createAnimal("duck");

		if (duckClicked == 0) {
			duck.setIcon(duckfactory.appear());
			duck.setVisible(true);
			duckClicked = 1;
		} else if (duckClicked == 1) {
			duck.setIcon(duckfactory.disappear());
			duck.setVisible(true);
			duckClicked = 0;
		}
		duck.revalidate();
	...
	private void swanImage(java.awt.event.ActionEvent animalEvent) {// GEN-FIRST:event_batbtnActionPerformed
		horse.setVisible(false);
		tiger.setVisible(false);
		donkey.setVisible(false);
		duck.setVisible(false);
		...
		// Pattern-----------------------------------
		AnimalFactory birdfactory = new BirdFactory();
		Animal swanfactory = birdfactory.createAnimal("swan");

		if (swanClicked == 0) {
			swan.setIcon(swanfactory.appear());
			swan.setVisible(true);
			swanClicked = 1;
		} else if (swanClicked == 1) {
			swan.setIcon(swanfactory.disappear());
			swan.setVisible(true);
			swanClicked = 0;
		}
		swan.revalidate();
	...
	private void horseImage(java.awt.event.ActionEvent animalEvent) {// GEN-FIRST:event_lampbtnActionPerformed
		tiger.setVisible(false);
		duck.setVisible(false);
		lion.setVisible(false);
		donkey.setVisible(false);
	...
	private void donkeyImage(java.awt.event.ActionEvent animalEvent) {// GEN-FIRST:event_pumpkinbtnActionPerformed
		horse.setVisible(false);
		tiger.setVisible(false);
		duck.setVisible(false);
		swan.setVisible(false);
	...
	private void zebraImage(java.awt.event.ActionEvent animalEvent) {// GEN-FIRST:event_bannerbtn1ActionPerformed
		horse.setVisible(false);
		tiger.setVisible(false);
		donkey.setVisible(false);
		duck.setVisible(false);
	...
	private void allImage(java.awt.event.ActionEvent animalEvent) {// GEN-FIRST:event_allActionPerformed
		zebra.setVisible(false);
		lion.setVisible(false);
		swan.setVisible(false);
		donkey.setVisible(false);
		...
		Animal lion1 = catfactory.createAnimal("lion");
		Animal tiger1 = catfactory.createAnimal("tiger");
		Animal duck1 = birdfactory.createAnimal("duck");
		Animal swan1 = birdfactory.createAnimal("swan");
		// -------------------------------------------Facade
		// Pattern----------------------------------------------
		...
		if (allAnimalsClicked == 0) {
			animals.clickAll(swan, duck, lion, tiger);
			allAnimalsClicked = 1;

		} else if (allAnimalsClicked == 1) {
			animals.unclickAll(swan, duck, lion, tiger);
			allAnimalsClicked = 0;
		}
	}
